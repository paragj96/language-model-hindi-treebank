...
if __name__ == '__main__':
    ...
    inputPath = '/home/aishwary/Desktop/ltrc '
        ...
        for tree in d.nodeList:
            for chunkNode in tree.nodeList:
                for node in chunkNode.nodeList:
                    print "TOKEN:" + node.name.encode('utf-8') + "\tTYPE:" + node.type.encode('utf-8')
                    ...
                    #    print "SSF VALUE:" + tree.printSSFValue()
                    #    print "TREE INFO:" + tree.header + tree.text + tree.footer
